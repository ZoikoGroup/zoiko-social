...
import { WINDOW_END_LABEL } from "./events";
...
export function EverythingBox() {
  return (
    <section className="py-10 sm:py-12" style={{ background: C.panel }}>
      <div className={WRAP}>
        <div
        ...
        >
          <div>
            <p className="text-lg font-extrabold" style={{ color: C.ink }}>
              That&apos;s everything eligible through {WINDOW_END_LABEL}.
            </p>
            <p className="mt-1 text-sm" style={{ color: C.muted }}>
              Nothing landing in November yet? Extend your planning horizon, or
    ...
    <section className="bg-white py-14 sm:py-20">
      <div className={WRAP}>
        <h2 className="text-2xl font-extrabold sm:text-3xl" style={{ color: C.ink }}>
          Trust you can check before you RSVP
        </h2>
        <p className="mt-1.5 max-w-[540px] text-base leading-6" style={{ color: C.muted }}>
          Organizer standing, venue privacy and reporting — visible on every
          listing.
        </p>
        ...
        >
          <div className="max-w-[520px]">
            <h2 className="text-2xl font-extrabold leading-tight sm:text-3xl">
              Follow a few organizers and let the plan come to you.
            </h2>
            <p className="mt-3 text-sm leading-6 text-white/80 sm:text-base">
              Join free to save events, get material-change alerts, and choose
              your own digest cadence.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <a
