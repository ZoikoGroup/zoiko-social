...
const CATEGORIES = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15.6 3.45C14.4 2.25 12.45 2.25 11.25 3.45L9 5.7L6.75 3.45C5.55 2.25 3.6 2.25 2.4 3.45C1.2 4.65 1.2 6.6 2.4 7.8L9 14.25L15.6 7.8C16.8 6.6 16.8 4.65 15.6 3.45Z" stroke="#066879" strokeWidth="1.5"/>
      </svg>
    ),
  },
  {
    ...
    description: "Explore communities focused on fostering, rescue, and adoption.",
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="w-full flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {CATEGORIES.map((category) => (
          ...
          >
            <div className="size-9 bg-cyan-50 rounded-xl flex items-center justify-center">
              {category.icon}
            </div>
