/**
 * events-training-workshops design tokens.
 *
...
export const C = {
  ...
  line: "#DCEAEE",
  /** Instructor pill, the trust panel and its icon chips. */
  chip: "#EEF8F9",
  /** Page background. */
  panel: "#F7F9FA",
  /** Join Waitlist and Professional-only fill; the highlighted trust card. */
  chipWarm: "#FBEEDF",
  /** Warm text: reasons, date badge month, Join Waitlist. */
  warm: "#C2700C",
  /** Warm accent. */
  warmBright: "#E88924",
} as const;
