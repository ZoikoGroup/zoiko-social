...
export default function ClosingBand() {
  return (
    <>
      <section
        className="mt-10 flex flex-col gap-6 rounded-3xl px-6 py-8 sm:px-10 lg:flex-row lg:items-center lg:justify-between"
      ...
      >
        <div className="max-w-[560px]">
          ...
          <p className="mt-2 text-sm leading-5 text-white/85">
            Browse every verified listing on Zoiko Social, not just what&apos;s
            near your current region.
          </p>
        </div>
