...
/**
 * Moderation queue, as a section of the single admin panel.
 *
 * Extracted from its own page: auth, the app Header and the page frame now
 * belong to the panel shell, so this file is only the queue itself. Five
 * separate admin pages each re-implemented the same permission check and the
 * same chrome.
 */
...
export function ModerationSection(): React.JSX.Element {
