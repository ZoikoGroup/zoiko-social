...
export default function AnimatedAuthLogin(): React.JSX.Element {
        ...
        <div className="bg-surface rounded-xl shadow-sm border border-outline-variant/40 overflow-hidden">
          <div className="p-8 md:p-10 space-y-6">
            ...
            <p className="text-center text-body-md text-on-surface-variant">
              ...
              <Link href="/signup" className="text-primary hover:text-primary-fixed-dim font-semibold transition-colors">
                Sign up
              </Link>
            </p>
          </div>
